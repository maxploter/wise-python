...
class TestOriginatorAddress(unittest.TestCase):
    """OriginatorAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OriginatorAddress:
        """Test OriginatorAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OriginatorAddress`
        """
    ...
    def testOriginatorAddress(self):
        """Test OriginatorAddress"""
