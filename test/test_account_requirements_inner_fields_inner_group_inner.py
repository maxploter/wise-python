...
class TestAccountRequirementsInnerFieldsInnerGroupInner(unittest.TestCase):
    """AccountRequirementsInnerFieldsInnerGroupInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountRequirementsInnerFieldsInnerGroupInner:
        """Test AccountRequirementsInnerFieldsInnerGroupInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountRequirementsInnerFieldsInnerGroupInner`
        """
        model = AccountRequirementsInnerFieldsInnerGroupInner()
        if include_optional:
            return AccountRequirementsInnerFieldsInnerGroupInner(
                key = '',
                name = '',
                type = '',
                required = True,
    ...
    def testAccountRequirementsInnerFieldsInnerGroupInner(self):
        """Test AccountRequirementsInnerFieldsInnerGroupInner"""
