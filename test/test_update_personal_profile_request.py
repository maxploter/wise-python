...
class TestUpdatePersonalProfileRequest(unittest.TestCase):
    """UpdatePersonalProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePersonalProfileRequest:
        """Test UpdatePersonalProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePersonalProfileRequest`
        """
    ...
    def testUpdatePersonalProfileRequest(self):
        """Test UpdatePersonalProfileRequest"""
