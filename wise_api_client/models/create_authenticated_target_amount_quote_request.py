...
class CreateAuthenticatedTargetAmountQuoteRequest(BaseModel):
    """
    ...
    target_amount: Union[StrictFloat, StrictInt] = Field(description="The amount in the target currency. Must be greater than 0.", alias="targetAmount")
    __properties: ClassVar[List[str]] = ["sourceCurrency", "targetCurrency", "targetAccount", "payOut", "preferredPayIn", "paymentMetadata", "pricingConfiguration", "targetAmount"]
