...
class ClientErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="Specific error code")
    message: StrictStr = Field(description="Human-readable error message")
    path: StrictStr = Field(description="The field path that caused the error")
    arguments: List[StrictStr] = Field(description="Additional arguments related to the error")
    __properties: ClassVar[List[str]] = ["code", "message", "path", "arguments"]
