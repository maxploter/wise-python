...
class CreateAuthenticatedSourceAmountQuoteRequest(BaseModel):
    """
    ...
    source_amount: Union[StrictFloat, StrictInt] = Field(description="The amount in the source currency. Must be greater than 0.", alias="sourceAmount")
    __properties: ClassVar[List[str]] = ["sourceCurrency", "targetCurrency", "targetAccount", "payOut", "preferredPayIn", "paymentMetadata", "pricingConfiguration", "sourceAmount"]
