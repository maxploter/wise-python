...
class CreateRecipientRequest(BaseModel):
    ...
    """ # noqa: E501
    currency: Annotated[str, Field(min_length=3, strict=True, max_length=3)] = Field(description="ISO 4217 three-letter currency code")
    type: StrictStr = Field(description="The type of recipient account, determined from the account requirements.")
    profile: Annotated[int, Field(strict=True, ge=1)] = Field(description="A unique profile identifier")
    account_holder_name: StrictStr = Field(description="The recipient's full name.", alias="accountHolderName")
    owned_by_customer: Optional[StrictBool] = Field(default=None, description="Whether this account is owned by the sending user.", alias="ownedByCustomer")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["currency", "type", "profile", "accountHolderName", "ownedByCustomer"]
