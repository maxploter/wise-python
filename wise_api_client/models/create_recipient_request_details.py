...
class CreateRecipientRequestDetails(BaseModel):
    """
    CreateRecipientRequestDetails
    """ # noqa: E501
    legal_type: StrictStr = Field(alias="legalType")
    ...
    __properties: ClassVar[List[str]] = ["legalType", "sortCode", "accountNumber", "dateOfBirth"]

    @field_validator('legal_type')
    def legal_type_validate_enum(cls, value):
        """Validates the enum"""
