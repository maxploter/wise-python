...
class CreateUnauthenticatedSourceAmountQuoteRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sourceCurrency", "targetCurrency", "pricingConfiguration", "sourceAmount"]
