...
class CreateUnauthenticatedTargetAmountQuoteRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sourceCurrency", "targetCurrency", "pricingConfiguration", "targetAmount"]
