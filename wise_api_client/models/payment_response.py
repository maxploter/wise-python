...
class PaymentResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The status of the payment. Common values include COMPLETED and REJECTED. This list may be extended by the API provider.")
